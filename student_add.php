...
<div class="container-fluid1">
	...
	<div class="content">
		<ol class="breadcrumb">
          ...
          <li><a href="inst_add.php">学生添加</a></li>
		</ol>
		<div class="box6">
		<div class="box7">
            <form class="form-horizontal" role="form" method="post" action="student_check_ok.php" name='inst' onSubmit="return check_input(inst) ">
                <div class="title">学生添加页面</div>
