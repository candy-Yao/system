...
<div class="container-fluid1">
	...
	<div class="content">
		<ol class="breadcrumb">
          ...
          <li class="active">学院添加</li>
		</ol>
		<div class="box6">
		<div class="box7">
            <form class="form-horizontal" role="form" method="post" action="manager_check_ok.php" name='inst' onSubmit="return check_input(inst) ">
                <div class="title">学院添加页面</div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">学院编号：</label>
                    <div class="col-sm-8">
...
<div class="foot_add">重庆师范大学&nbsp;计算机科学与技术专业&nbsp;爱好编&&擅长写代码的姚星如&nbsp;版权所有&nbsp;Tel:18323230431&nbsp;QQ:2651169635</div>
