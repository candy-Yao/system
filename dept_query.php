...
<div class="container-fluid1">
	...
	<div class="content">
		<ol class="breadcrumb">
		  ...
		  <li class="active">所在系查询</li>
		</ol>
		<div class="box6">
		<div class="box7">
        <div class="title">所在系信息查询</div>
<?php
            $conn = mysqli_connect("yxr.dev.dxdc.net:3306","a0915222653","57558434","a0915222653");
			mysqli_query($conn,"set names utf8");
			$sql=mysqli_query($conn,"select * from tb_stud s inner join tb_class c on s.Class_No=c.Class_No inner join tb_dept
			d on d.Dept_No=c.Dept_No where Sname='$username'"); 
...
?>
    ...
    <tbody>
        <tr class="info">
            <th scope="col" width="20%">系编号</th>
            <th scope="col" width="25%">系名称</th>
        </tr>
        <tr>
            <td><?php echo $info['Dept_No'];	?></td>
