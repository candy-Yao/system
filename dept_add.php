...
<div class="container-fluid1">
	...
	<div class="content">
		...
		<div class="box6">
		<div class="box7">
            <form class="form-horizontal" role="form" method="post" action="dept_check_ok.php" name='inst' onSubmit="return check_input(inst) ">
                <div class="title">系添加页面</div>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">系名称：</label>
                    <div class="col-sm-8">
