...
<div class="container-fluid1">
	...
	<div class="content">
		<ol class="breadcrumb">
		  ...
		  <li class="active">学生成绩添加</li>
		</ol>
		<div class="box6">
		<div class="box7">
 <form class="form-horizontal" role="form" method="post" action="grade_check_ok.php" name='inst' onSubmit="return check_input(inst) ">
                <div class="title">老师添加学生成绩</div>
