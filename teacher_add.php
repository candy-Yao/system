...
<div class="container-fluid1">
	...
	<div class="content">
		...
		<div class="box6">
		<div class="box7">
            <form class="form-horizontal" role="form" method="post" action="teacher_check_ok.php" name='inst' onSubmit="return check_input(inst) ">
                <div class="title">教师添加页面</div>
